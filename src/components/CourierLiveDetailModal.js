...
import CourierFullscreenRouteModal from './CourierFullscreenRouteModal';
...
export default function CourierLiveDetailModal({ visible, courier, order, onClose }) {
  const [dkd_fullscreen_map_value, dkd_set_fullscreen_map_value] = useState(false);
