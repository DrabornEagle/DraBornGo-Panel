...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: dkd_theme.background }, content: { padding: 14, paddingTop: 18 }, kicker: { color: dkd_theme.cyan, fontSize: 10.5, fontWeight: '900', letterSpacing: 1.4 }, title: { color: dkd_theme.text, fontSize: 27, fontWeight: '900', marginTop: 3 }, subtitle: { color: dkd_theme.textSoft, fontSize: 12, fontWeight: '700', marginTop: 3, marginBottom: 16 },
  infoCard: { flexDirection: 'row', gap: 10, padding: 13, borderRadius: 20, backgroundColor: 'rgba(91,224,163,.07)', borderWidth: 1, borderColor: 'rgba(91,224,163,.12)' }, infoIcon: { width: 43, height: 43, borderRadius: 15, backgroundColor: 'rgba(91,224,163,.10)', alignItems: 'center', justifyContent: 'center' }, infoTitle: { color: '#D7F8E8', fontSize: 12.5, fontWeight: '900' }, infoText: { color: '#9EC8B7', fontSize: 11, lineHeight: 14, fontWeight: '700', marginTop: 4 },
  formCard: { marginTop: 12, padding: 13, borderRadius: 23, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, field: { marginBottom: 10 }, label: { color: dkd_theme.muted, fontSize: 10, fontWeight: '900', letterSpacing: .7, marginBottom: 5 }, input: { minHeight: 48, borderRadius: 15, backgroundColor: 'rgba(255,255,255,.035)', borderWidth: 1, borderColor: dkd_theme.border, paddingHorizontal: 12, color: dkd_theme.text, fontSize: 12.5, fontWeight: '700' }, row: { flexDirection: 'row', gap: 8 }, error: { color: '#FFB0BA', fontSize: 11, fontWeight: '800', marginBottom: 8 }, saved: { color: '#A6EDCC', fontSize: 11, fontWeight: '800', marginBottom: 8 }, saveButton: { minHeight: 51, borderRadius: 16, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7 }, saveText: { color: '#07121D', fontSize: 12, fontWeight: '900', letterSpacing: .5 },
  securityCard: { marginTop: 12, padding: 13, borderRadius: 21, flexDirection: 'row', gap: 10, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, securityTitle: { color: dkd_theme.text, fontSize: 12.5, fontWeight: '900' }, securityText: { color: dkd_theme.textSoft, fontSize: 11, lineHeight: 14, fontWeight: '700', marginTop: 4 }, logout: { marginTop: 12, height: 49, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,107,124,.18)', backgroundColor: 'rgba(255,107,124,.06)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, logoutText: { color: '#FFAFB8', fontSize: 12, fontWeight: '900' }, version: { textAlign: 'center', color: '#53647B', fontSize: 10.5, fontWeight: '700', marginTop: 16 },
});
