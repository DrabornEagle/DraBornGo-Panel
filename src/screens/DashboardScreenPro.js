  ...
  >
    ...
    <LinearGradient colors={['#092938', '#10284F', '#2C1B50']} style={styles.operationPanel}>
      ...
      <View style={styles.operationHead}>
        <LinearGradient colors={['#66E8FF', '#67F0B2']} style={styles.operationIcon}><MaterialCommunityIcons name="bike-fast" size={27} color="#07131D" /></LinearGradient>
      ...
      {dkd_online_couriers.length > 0 && <View style={styles.operationCourierList}>
        {dkd_online_couriers.map((dkd_courier, dkd_index) => <View key={dkd_courier.dkd_courier_user_id} style={[styles.operationCourierRow, dkd_index > 0 && styles.operationCourierBorder]}>
          <LinearGradient colors={['rgba(99,235,255,.18)', 'rgba(98,240,182,.13)']} style={styles.avatar}><MaterialCommunityIcons name="motorbike" size={21} color="#75E8FF" /></LinearGradient>
...
const styles = StyleSheet.create({
  ...
  operationPanel: { borderRadius: 28, padding: 14, marginTop: 20, marginBottom: 4, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(111,227,255,.16)' }, operationGlowOne: { position: 'absolute', width: 170, height: 170, borderRadius: 999, right: -80, top: -95, backgroundColor: 'rgba(106,232,255,.10)' }, operationGlowTwo: { position: 'absolute', width: 160, height: 160, borderRadius: 999, left: -95, bottom: -110, backgroundColor: 'rgba(170,108,255,.10)' }, operationHead: { flexDirection: 'row', alignItems: 'center', gap: 11, marginBottom: 13 }, operationIcon: { width: 50, height: 50, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, operationCopy: { flex: 1, minWidth: 0 }, operationTitle: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' }, operationSub: { color: '#AABDD5', fontSize: 13.5, fontWeight: '700', marginTop: 3 }, operationLive: { minHeight: 31, paddingHorizontal: 9, borderRadius: 999, flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(82,234,173,.11)', borderWidth: 1, borderColor: 'rgba(82,234,173,.17)' }, operationLiveDot: { width: 7, height: 7, borderRadius: 99, backgroundColor: '#62F0B6' }, operationLiveText: { color: '#8BF4C8', fontSize: 11.5, fontWeight: '900', letterSpacing: .65 }, summaryRow: { flexDirection: 'row', gap: 8 }, operationMetric: { flex: 1, minHeight: 112, borderRadius: 20, padding: 11, borderWidth: 1, borderColor: 'rgba(255,255,255,.08)', overflow: 'hidden' }, operationMetricIcon: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,.08)' }, summaryNumber: { color: '#FFFFFF', fontSize: 25, fontWeight: '900', marginTop: 9 }, summaryLabel: { color: '#C6D3E4', fontSize: 13, fontWeight: '900', marginTop: 2 }, operationCourierList: { marginTop: 12, backgroundColor: 'rgba(3,10,24,.28)', borderRadius: 20, paddingHorizontal: 11, borderWidth: 1, borderColor: 'rgba(255,255,255,.06)' }, operationCourierRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10 }, operationCourierBorder: { borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.08)' },
  listCard: { backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border, borderRadius: 22, paddingHorizontal: 12 }, avatar: { width: 43, height: 43, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, rowCopy: { flex: 1, minWidth: 0 }, rowTitle: { color: dkd_theme.text, fontSize: 14.5, fontWeight: '900' }, rowSub: { color: dkd_theme.textSoft, fontSize: 13, fontWeight: '700', marginTop: 3 }, rowBorder: { borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.08)' }, orderCourier: { color: '#87DFF0', fontSize: 13, fontWeight: '800', marginTop: 4 }, orderRow: { minHeight: 88, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 11 }, orderIcon: { width: 43, height: 43, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,214,107,.08)' }, emptyText: { color: dkd_theme.textSoft, textAlign: 'center', padding: 24, fontSize: 14, fontWeight: '700' },
});
