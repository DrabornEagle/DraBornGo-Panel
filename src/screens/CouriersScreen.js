...
import {
  dkd_panel_fetch_courier_earnings, dkd_panel_fetch_couriers, dkd_panel_force_courier_offline, dkd_panel_link_courier,
...
const styles = StyleSheet.create({
  ...
  pageHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 7 }, pageKicker: { color: dkd_theme.cyan, fontSize: 13, fontWeight: '900', letterSpacing: 1.4 }, pageTitle: { color: dkd_theme.text, fontSize: 27, fontWeight: '900', marginTop: 3 }, pageSub: { color: dkd_theme.textSoft, fontSize: 14, fontWeight: '700', marginTop: 3 }, addButton: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: dkd_theme.cyan, minHeight: 43, paddingHorizontal: 12, borderRadius: 15 }, addButtonText: { color: '#07121D', fontSize: 13.5, fontWeight: '900' }, errorText: { color: '#FFB0BA', fontSize: 13.5, fontWeight: '800', padding: 7 },
  courierCard: { borderRadius: 23, padding: 13, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, courierTop: { flexDirection: 'row', gap: 11, alignItems: 'center' }, avatarLarge: { width: 52, height: 52, borderRadius: 18, backgroundColor: 'rgba(102,232,255,.08)', alignItems: 'center', justifyContent: 'center' }, courierCopy: { flex: 1 }, nameRow: { flexDirection: 'row', alignItems: 'center', gap: 7 }, courierName: { color: dkd_theme.text, fontSize: 14.5, fontWeight: '900', flex: 1 }, courierSub: { color: dkd_theme.textSoft, fontSize: 13, fontWeight: '700', marginTop: 4 }, courierTiny: { color: dkd_theme.muted, fontSize: 13, fontWeight: '700', marginTop: 4 }, rateGrid: { flexDirection: 'row', gap: 7, marginTop: 12 }, rateTile: { flex: 1, minHeight: 68, borderRadius: 15, padding: 9, backgroundColor: 'rgba(255,255,255,.028)', borderWidth: 1, borderColor: 'rgba(176,214,255,.06)' }, rateLabel: { color: dkd_theme.muted, fontSize: 13, fontWeight: '900', letterSpacing: .5 }, rateValue: { color: dkd_theme.text, fontSize: 14, fontWeight: '900', marginTop: 7 }, actionRow: { flexDirection: 'row', gap: 7, marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.07)' }, actionButton: { flex: 1, minHeight: 38, borderRadius: 13, backgroundColor: 'rgba(255,255,255,.035)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 }, actionText: { color: '#C0CFDF', fontSize: 13, fontWeight: '900' },
  sheetBackdrop: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0,0,0,.65)' }, sheet: { backgroundColor: '#08111E', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 14, maxHeight: '86%', borderWidth: 1, borderColor: dkd_theme.border }, sheetHandle: { width: 42, height: 4, backgroundColor: '#35445A', borderRadius: 9, alignSelf: 'center', marginBottom: 12 }, centerBackdrop: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 18, backgroundColor: 'rgba(0,0,0,.68)' }, dialog: { width: '100%', borderRadius: 25, padding: 14, backgroundColor: '#0A1423', borderWidth: 1, borderColor: dkd_theme.border }, dialogHead: { flexDirection: 'row', alignItems: 'center', gap: 10 }, dialogIcon: { width: 45, height: 45, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(102,232,255,.08)' }, dialogKicker: { color: dkd_theme.cyan, fontSize: 13, fontWeight: '900', letterSpacing: 1 }, dialogTitle: { color: dkd_theme.text, fontSize: 17, fontWeight: '900', marginTop: 2 }, dialogText: { color: dkd_theme.textSoft, fontSize: 13, lineHeight: 17, fontWeight: '700', marginVertical: 12 }, closeButton: { width: 39, height: 39, borderRadius: 14, backgroundColor: 'rgba(255,255,255,.05)', alignItems: 'center', justifyContent: 'center' },
  moneyRow: { flexDirection: 'row', gap: 8 }, moneyInputWrap: { flex: 1 }, inputLabel: { color: dkd_theme.muted, fontSize: 13, fontWeight: '900', letterSpacing: .6, marginBottom: 5 }, moneyInputShell: { minHeight: 48, borderRadius: 15, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,.035)', borderWidth: 1, borderColor: dkd_theme.border }, moneyInput: { flex: 1, color: dkd_theme.text, fontSize: 14, fontWeight: '900', paddingVertical: 0 }, tl: { color: dkd_theme.cyan, fontSize: 13, fontWeight: '900' }, primaryButton: { minHeight: 52, borderRadius: 16, marginTop: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, primaryButtonText: { color: '#07121D', fontSize: 13.5, fontWeight: '900', textAlign: 'center' },
  searchRow: { flexDirection: 'row', gap: 7, marginTop: 13 }, searchShell: { flex: 1, minHeight: 48, borderRadius: 16, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,.035)', borderWidth: 1, borderColor: dkd_theme.border }, searchInput: { flex: 1, color: dkd_theme.text, fontSize: 14, fontWeight: '700' }, searchButton: { width: 49, height: 49, borderRadius: 16, backgroundColor: dkd_theme.cyan, alignItems: 'center', justifyContent: 'center' }, searchHint: { color: dkd_theme.muted, fontSize: 13, lineHeight: 17, fontWeight: '700', marginTop: 7 }, searchResult: { minHeight: 66, borderRadius: 17, padding: 9, flexDirection: 'row', alignItems: 'center', gap: 9, marginTop: 7, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, searchResultActive: { borderColor: 'rgba(102,232,255,.55)', backgroundColor: 'rgba(102,232,255,.06)' }, avatar: { width: 40, height: 40, borderRadius: 14, backgroundColor: 'rgba(102,232,255,.08)', alignItems: 'center', justifyContent: 'center' }, resultName: { color: dkd_theme.text, fontSize: 14, fontWeight: '900' }, resultSub: { color: dkd_theme.textSoft, fontSize: 13, fontWeight: '700', marginTop: 3 }, rateBlock: { marginTop: 12, paddingTop: 11, borderTopWidth: 1, borderTopColor: dkd_theme.border }, rateTitle: { color: dkd_theme.text, fontSize: 15, fontWeight: '900', marginBottom: 9 },
  earningsHero: { minHeight: 125, borderRadius: 21, marginTop: 10, padding: 15, backgroundColor: '#10283A', borderWidth: 1, borderColor: 'rgba(102,232,255,.12)' }, earningsLabel: { color: '#88DAE7', fontSize: 13, fontWeight: '900', letterSpacing: .8 }, earningsValue: { color: dkd_theme.text, fontSize: 28, fontWeight: '900', marginTop: 8 }, earningsSub: { color: dkd_theme.textSoft, fontSize: 13.5, fontWeight: '700', marginTop: 6 }, earningGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 9 }, earningTile: { width: '48.5%', minHeight: 94, borderRadius: 18, padding: 11, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, earningTileLabel: { color: dkd_theme.muted, fontSize: 13, fontWeight: '900', marginTop: 7 }, earningTileValue: { color: dkd_theme.text, fontSize: 15, fontWeight: '900', marginTop: 5 }, note: { color: dkd_theme.muted, fontSize: 13, lineHeight: 17, fontWeight: '700', marginTop: 10, marginBottom: 20 },
});
