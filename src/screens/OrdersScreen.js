...
const styles = StyleSheet.create({
  ...
  topRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 7 }, kicker: { color: dkd_theme.cyan, fontSize: 8.5, fontWeight: '900', letterSpacing: 1.4 }, title: { color: dkd_theme.text, fontSize: 27, fontWeight: '900', marginTop: 3 }, subtitle: { color: dkd_theme.textSoft, fontSize: 10, fontWeight: '700', marginTop: 3 }, countBubble: { width: 59, height: 59, borderRadius: 20, backgroundColor: '#11203A', borderWidth: 1, borderColor: dkd_theme.border, alignItems: 'center', justifyContent: 'center' }, countValue: { color: dkd_theme.text, fontSize: 20, fontWeight: '900' }, countLabel: { color: dkd_theme.muted, fontSize: 7, fontWeight: '900', letterSpacing: .8 },
  filters: { flexDirection: 'row', gap: 6, marginBottom: 5 }, filter: { flex: 1, height: 38, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, filterActive: { backgroundColor: '#173250', borderColor: 'rgba(102,232,255,.22)' }, filterText: { color: dkd_theme.muted, fontSize: 8.5, fontWeight: '900' }, filterTextActive: { color: '#C5F7FF' }, errorText: { color: '#FFB0BA', fontSize: 10, fontWeight: '800', padding: 10 },
  orderCard: { borderRadius: 22, padding: 13, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, orderTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, orderIcon: { width: 43, height: 43, borderRadius: 15, backgroundColor: 'rgba(255,214,107,.08)', alignItems: 'center', justifyContent: 'center' }, orderCopy: { flex: 1, minWidth: 0 }, orderTitle: { color: dkd_theme.text, fontSize: 11, fontWeight: '900' }, orderAddress: { color: dkd_theme.textSoft, fontSize: 9, lineHeight: 13, fontWeight: '700', marginTop: 3 }, orderMeta: { flexDirection: 'row', gap: 7, marginTop: 12 }, metaItem: { flex: 1, minHeight: 34, borderRadius: 12, backgroundColor: 'rgba(255,255,255,.025)', flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8 }, metaText: { color: '#B6C4D8', fontSize: 8.5, fontWeight: '800', flexShrink: 1 }, orderBottom: { flexDirection: 'row', alignItems: 'center', marginTop: 10, paddingTop: 9, borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.07)' }, orderTime: { flex: 1, color: '#687A93', fontSize: 8.5, fontWeight: '700' }, detailButton: { flexDirection: 'row', alignItems: 'center', gap: 2 }, detailButtonText: { color: '#BEEFFF', fontSize: 9, fontWeight: '900' },
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,.62)', justifyContent: 'flex-end' }, modalSheet: { maxHeight: '90%', backgroundColor: '#08111E', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 14, borderWidth: 1, borderColor: dkd_theme.border }, modalHandle: { alignSelf: 'center', width: 42, height: 4, borderRadius: 9, backgroundColor: '#344258', marginBottom: 12 }, detailHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 12 }, detailIcon: { width: 45, height: 45, borderRadius: 16, backgroundColor: 'rgba(255,214,107,.08)', alignItems: 'center', justifyContent: 'center' }, detailKicker: { color: dkd_theme.yellow, fontSize: 8, fontWeight: '900', letterSpacing: 1 }, detailTitle: { color: dkd_theme.text, fontSize: 20, fontWeight: '900', marginTop: 2 }, closeButton: { width: 40, height: 40, borderRadius: 14, backgroundColor: 'rgba(255,255,255,.05)', alignItems: 'center', justifyContent: 'center' },
  mapWrap: { height: 225, borderRadius: 23, overflow: 'hidden', borderWidth: 1, borderColor: dkd_theme.border }, map: { flex: 1 }, mapBadge: { position: 'absolute', top: 10, left: 10, flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(5,12,22,.88)', borderRadius: 11, paddingHorizontal: 9, paddingVertical: 7 }, liveDot: { width: 7, height: 7, borderRadius: 8, backgroundColor: dkd_theme.green }, mapBadgeText: { color: dkd_theme.text, fontSize: 8, fontWeight: '900' },
  detailGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 10 }, detailTile: { width: '48.5%', minHeight: 83, borderRadius: 18, padding: 11, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, detailLabel: { color: dkd_theme.muted, fontSize: 7.5, fontWeight: '900', letterSpacing: .7, marginBottom: 9 }, detailValue: { color: dkd_theme.text, fontSize: 14, fontWeight: '900' }, infoCard: { borderRadius: 19, padding: 12, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border }, infoTitle: { color: dkd_theme.text, fontSize: 12, fontWeight: '900' }, infoText: { color: dkd_theme.textSoft, fontSize: 9.5, fontWeight: '700', marginTop: 4 }, infoTiny: { color: dkd_theme.muted, fontSize: 8, fontWeight: '700', marginTop: 7 },
  timelineRow: { minHeight: 42, flexDirection: 'row', alignItems: 'center', gap: 8 }, timelineBorder: { borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.07)' }, timelineDot: { width: 9, height: 9, borderRadius: 9, backgroundColor: '#37455A' }, timelineDotActive: { backgroundColor: dkd_theme.green }, timelineLabel: { color: dkd_theme.text, fontSize: 9.5, fontWeight: '800', flex: 1 }, timelineTime: { color: dkd_theme.textSoft, fontSize: 8.5, fontWeight: '700' },
});
