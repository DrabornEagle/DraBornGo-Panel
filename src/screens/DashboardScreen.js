...
const styles = StyleSheet.create({
  ...
  loader: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: dkd_theme.background, gap: 10 }, loaderText: { color: dkd_theme.textSoft, fontSize: 14, fontWeight: '800' },
  error: { flexDirection: 'row', gap: 8, alignItems: 'center', backgroundColor: 'rgba(255,107,124,.08)', borderRadius: 14, padding: 10, marginTop: 10 }, errorText: { flex: 1, color: '#FFB5BD', fontSize: 13.5, fontWeight: '800' },
  metricGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 9, marginTop: 10 },
  summaryRow: { flexDirection: 'row', gap: 8 }, summaryCard: { flex: 1, minHeight: 104, backgroundColor: dkd_theme.surface, borderWidth: 1, borderColor: dkd_theme.border, borderRadius: 20, padding: 12 }, summaryNumber: { color: dkd_theme.text, fontSize: 24, fontWeight: '900', marginTop: 9 }, summaryLabel: { color: dkd_theme.textSoft, fontSize: 13, fontWeight: '900', marginTop: 2 },
  ...
  courierRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10 }, rowBorder: { borderTopWidth: 1, borderTopColor: 'rgba(176,214,255,.08)' }, avatar: { width: 42, height: 42, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(102,232,255,.08)' }, rowCopy: { flex: 1, minWidth: 0 }, rowTitle: { color: dkd_theme.text, fontSize: 14, fontWeight: '900' }, rowSub: { color: dkd_theme.textSoft, fontSize: 13, fontWeight: '700', marginTop: 3 }, orderCourier: { color: '#87DFF0', fontSize: 13, fontWeight: '800', marginTop: 4 },
  orderRow: { minHeight: 88, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 11 }, orderIcon: { width: 42, height: 42, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,214,107,.08)' }, emptyText: { color: dkd_theme.textSoft, textAlign: 'center', padding: 24, fontSize: 14, fontWeight: '700' },
});
