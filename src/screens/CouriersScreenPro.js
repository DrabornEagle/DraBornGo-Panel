      ...
      <Animated.View style={{ opacity: dkd_intro_value, transform: [{ translateY: dkd_translate_value }] }}>
        <LinearGradient colors={['#09233A', '#102C59', '#2A1850']} style={styles.heroCard}>
          ...
          <View style={styles.heroTopRow}>
            <View style={styles.heroIcon}><MaterialCommunityIcons name="account-group" size={30} color="#07121D" /></View>
...
const styles = StyleSheet.create({
  ...
  heroCard: { borderRadius: 30, padding: 18, marginBottom: 14, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(128,229,255,.17)' }, heroGlowOne: { position: 'absolute', width: 190, height: 190, borderRadius: 999, right: -80, top: -90, backgroundColor: 'rgba(105,234,255,.11)' }, heroGlowTwo: { position: 'absolute', width: 160, height: 160, borderRadius: 999, left: -90, bottom: -100, backgroundColor: 'rgba(167,139,250,.11)' }, heroTopRow: { flexDirection: 'row', alignItems: 'center', gap: 11 }, heroIcon: { width: 56, height: 56, borderRadius: 20, backgroundColor: '#6DEBFF', alignItems: 'center', justifyContent: 'center' }, heroCopy: { flex: 1, minWidth: 0 }, pageKicker: { color: '#9EF4FF', fontSize: 13.5, fontWeight: '900', letterSpacing: 1.3 }, pageTitle: { color: '#FFFFFF', fontSize: 29, lineHeight: 34, fontWeight: '900', marginTop: 2, letterSpacing: -.65 }, pageSub: { color: '#B7C8DF', fontSize: 16, lineHeight: 22, fontWeight: '700', marginTop: 13 }, addButtonWrap: { borderRadius: 18, overflow: 'hidden' }, addButton: { minHeight: 52, paddingHorizontal: 12, borderRadius: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, addButtonText: { color: '#07121D', fontSize: 14, fontWeight: '900' }, heroStatRow: { flexDirection: 'row', gap: 10, marginTop: 17 }, heroStat: { flex: 1, minHeight: 64, borderRadius: 20, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 11, backgroundColor: 'rgba(2,10,24,.30)', borderWidth: 1, borderColor: 'rgba(255,255,255,.08)' }, onlineDot: { width: 13, height: 13, borderRadius: 99, backgroundColor: '#62F0B6' }, totalDot: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(141,165,255,.12)' }, heroStatLabel: { color: '#91A5BF', fontSize: 12.5, fontWeight: '900', letterSpacing: .7 }, heroStatValue: { color: '#FFFFFF', fontSize: 19, fontWeight: '900', marginTop: 1 },
