...
const styles = StyleSheet.create({
  ...
  brandKicker: { color: '#9DEFFF', fontSize: 12.5, fontWeight: '900', letterSpacing: 1.45 },
  ...
  liveText: { color: '#A9F6CF', fontSize: 12, fontWeight: '900', letterSpacing: .7 },
  ...
  featureText: { color: '#D8E4F4', fontSize: 13, fontWeight: '900' },
  ...
  formEyebrow: { color: '#78EFFF', fontSize: 12.5, fontWeight: '900', letterSpacing: 1.2 },
  ...
  quickInfoText: { color: '#99CBB4', fontSize: 13, lineHeight: 16, fontWeight: '700', marginTop: 2 },
  inputWrap: { marginBottom: 15 },
  inputLabel: { color: '#8CA1BF', fontSize: 12.5, fontWeight: '900', letterSpacing: .95, marginBottom: 8, marginLeft: 4 },
  ...
  securityText: { color: '#7899A3', fontSize: 12, fontWeight: '800' },
  legal: { color: '#61748D', fontSize: 12, lineHeight: 16, textAlign: 'center', fontWeight: '700', marginTop: 10, paddingHorizontal: 10 },
});
