...
const styles = StyleSheet.create({
  ...
  brandKicker: { color: '#9DEFFF', fontSize: 11, fontWeight: '900', letterSpacing: 1.45 },
  ...
  liveText: { color: '#A9F6CF', fontSize: 10, fontWeight: '900', letterSpacing: .7 },
  ...
  featureText: { color: '#D8E4F4', fontSize: 11.5, fontWeight: '900' },
  ...
  formEyebrow: { color: '#78EFFF', fontSize: 11, fontWeight: '900', letterSpacing: 1.2 },
  formTitle: { color: '#FFFFFF', fontSize: 24, lineHeight: 29, fontWeight: '900', marginTop: 6 },
  formDescription: { color: '#91A6C1', fontSize: 13.5, lineHeight: 20, fontWeight: '700', marginTop: 5 },
  ...
  quickInfoTitle: { color: '#C8F7E0', fontSize: 13.5, fontWeight: '900' },
  quickInfoText: { color: '#99CBB4', fontSize: 11.5, lineHeight: 16, fontWeight: '700', marginTop: 2 },
  inputWrap: { marginBottom: 15 },
  inputLabel: { color: '#8CA1BF', fontSize: 11, fontWeight: '900', letterSpacing: .95, marginBottom: 8, marginLeft: 4 },
  ...
  errorText: { color: '#FFC1C8', fontSize: 13, lineHeight: 18, fontWeight: '800', flex: 1 },
  ...
  noticeText: { color: '#C2F5DC', fontSize: 13, lineHeight: 18, fontWeight: '800', flex: 1 },
  ...
  securityText: { color: '#7899A3', fontSize: 10.5, fontWeight: '800' },
  legal: { color: '#61748D', fontSize: 10.5, lineHeight: 16, textAlign: 'center', fontWeight: '700', marginTop: 10, paddingHorizontal: 10 },
});
