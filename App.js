...
const styles=StyleSheet.create({
  safe:{flex:1,backgroundColor:dkd_theme.background},appRoot:{flex:1,backgroundColor:dkd_theme.background},loading:{flex:1,alignItems:'center',justifyContent:'center',backgroundColor:dkd_theme.background,padding:28,gap:10},loadingText:{color:dkd_theme.textSoft,fontSize:15,fontWeight:'800'},errorTitle:{color:dkd_theme.text,fontSize:22,fontWeight:'900',textAlign:'center'},errorText:{color:dkd_theme.textSoft,fontSize:14.5,lineHeight:21,fontWeight:'700',textAlign:'center',maxWidth:340},retry:{marginTop:10,minHeight:50,minWidth:140,borderRadius:15,backgroundColor:dkd_theme.cyan,alignItems:'center',justifyContent:'center'},retryText:{color:'#07121D',fontSize:14,fontWeight:'900'},logoutMini:{minHeight:44,minWidth:120,alignItems:'center',justifyContent:'center'},logoutMiniText:{color:'#FF9EAA',fontSize:13.5,fontWeight:'900'},navWrap:{position:'absolute',left:8,right:8,bottom:8},navBar:{minHeight:80,borderRadius:26,paddingHorizontal:4,flexDirection:'row',alignItems:'center',backgroundColor:'rgba(8,17,30,.98)',borderWidth:1,borderColor:'rgba(166,217,255,.16)'},navItem:{flex:1,minWidth:0,alignItems:'center',justifyContent:'center',gap:4},navIcon:{width:38,height:38,borderRadius:13,alignItems:'center',justifyContent:'center'},navIconActive:{backgroundColor:dkd_theme.cyan},navText:{color:'#71839C',fontSize:11.5,fontWeight:'900'},navTextActive:{color:'#CFF8FF'}
});
